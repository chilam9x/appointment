...
class Student extends Model
{
    ...
    public static function checkStudent($request)
    {
        ...
        ->select('s.*','a.id as ap_id','a.date','a.start_time','a.finish_time','a.created_at as ap_created_at','c.name as category_name','as.first_name as advisor_first_name','as.last_name as advisor_last_name')
        ->orderBy('a.id','desc')
        ->get();
        return $res;
    }
